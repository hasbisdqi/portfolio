...
export default function Home() {
  return (
    <div className="flex justify-center items-center mt-20">
      <div className="grid grid-cols-12 gap-8 sm:max-w-screen-lg">
        <div className="text-center max-w-sm col-span-full sm:col-span-5 mx-auto my-auto">
        ...
        <div className="grid md:grid-cols-2 gap-2 col-span-full sm:col-span-7">
          <div className="border border-primary rounded-lg bg-gradient-to-b from-primary/5 p-4 max-w-sm sm:max-w-full">
